...
Run interface.py to operate the nuker using an User Interface, run asc_mkii.py to operate the nuker using the terminal.
...
Recommended Python Version:
    Python 3.11.9 or lower (due to compatibility constraints)
...
B. iOS (Mobile)
    ...
    02. Follow equivalent steps based on platform limitations
